...
class _$AppDatabase extends AppDatabase {
  ...
  TransactionsDao? _transactionDaoInstance;
    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `transactions` (`id` INTEGER, `amount` INTEGER, `date` TEXT, `note` TEXT, `category` TEXT, PRIMARY KEY (`id`))');
  ...
  @override
  TransactionsDao get transactionDao {
